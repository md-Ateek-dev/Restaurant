...
function Model() {
  ...
  const texture = useTexture("/Banner7.avif")
  ...
  function Images(viewport) {
    ...
    const texture1 = useTexture("/Banner7.avif")
    ...
    const texture2 = useTexture("Banner7.avif")
    ...
    <group>
      ...
      <mesh>
        ...
        <shaderMaterial
          ...
          transparent={true}
          uniforms={uniforms.current}></shaderMaterial>
      </mesh>
    </group>
  );
}
